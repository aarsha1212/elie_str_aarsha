...
Cfg.dataset_dir = '/home/aarsha/ELIE_STR-main/dataset/Sony/'
...
Cfg.test_tar = './results1/resultssony/epoch_2.tar'

# craft text detection related hyperparameters
